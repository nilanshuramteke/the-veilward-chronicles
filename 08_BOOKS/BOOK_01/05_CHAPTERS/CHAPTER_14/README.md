...
Chapter 14 is the false-convergence chapter immediately preceding the Chapter 15 midpoint. A formal institutional review compels Aurelia and Aarav to disclose their three accumulated evidence threads together for the first time; the Academy responds with a credible but unproven theory built on a disturbed seal in a long-decommissioned sub-level corridor — that an intruder has been entering Veilward. Aarav is tempted to accept it as the investigation's first genuinely verifiable evidence, until Aurelia's plain, direct question exposes a gap in his own usually-rigorous method: passage proves nothing about origin. Unable to resolve the disagreement through argument, they choose to verify the corridor themselves, openly, before it is sealed — acting together while still disagreeing — and the chapter ends the instant the sealed door opens. Chapter 15 owns everything beyond it.
...
**Chapter 13 continuity:** `chapter-13-finalization-record.md`, `chapter-13-to-chapter-14-handoff.md` (both in `CHAPTER_13/`).

**Chapter 12 continuity (background):** `chapter-12-finalization-record.md`, `chapter-12-to-chapter-13-continuity-handoff.md`, `chapter-12-to-chapter-13-state-lock.md` (all in `CHAPTER_12/`).

**Chapter 14 planning history:** Phase 1 Orientation Report, Phase 2 Detailed Scene Plan, Phase 3.1 Targeted Calibration Report, Phase 3.1 Reconciliation Report, Phase 3.2 Final Calibration Report (all conversation-authoritative; Phase 3.2 is binding).

**Series/Book canon:** `08_BOOKS/BOOK_01/book-01-canon-lock.md`, `08_BOOKS/BOOK_01/04_WORLD_AND_LOCATIONS/book-01-magic-usage-lock.md`, `08_BOOKS/BOOK_01/05_CHAPTERS/chapter-outline.md`, `08_BOOKS/BOOK_01/01_PLOT/act-structure.md`, `07_SERIES_BLUEPRINT/revelation-matrix.md`, `08_BOOKS/BOOK_01/02_MYSTERY/unknown-student-thread.md`, `05_LORE_AND_HISTORY/serpentfire-history.md`, `02_MAGIC_AND_SPECIES/naga.md`, `04_CHARACTERS/aarav.md`, `04_CHARACTERS/aurelia.md`, `04_CHARACTERS/mira.md`, `04_CHARACTERS/professor-elian-voss.md`, `04_CHARACTERS/relationship-aurelia-and-aarav.md`, `06_WRITING_GUIDE/character-voice-guide.md`, `06_WRITING_GUIDE/romance-writing-guide.md`, `06_WRITING_GUIDE/prohibited-patterns.md`, `06_WRITING_GUIDE/dialogue-guide.md`, `06_WRITING_GUIDE/action-and-magic-scenes.md`, `06_WRITING_GUIDE/pacing-guide.md`.
